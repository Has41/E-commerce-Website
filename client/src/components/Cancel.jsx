      ...
      <section className='bg-slate-50 py-20'>
        <div className='bg-white lg:w-[50%] w-[92%] mx-auto py-14 shadow-md'>
          <div className='text-center'>
            <i className='bx bxs-x-circle lg:text-[100px] text-[60px] text-red-600'></i>
          </div>
        <div className='lg:text-3xl text-lg pt-6 text-center font-bold uppercase'>Payment Failed!</div>
        <div className='text-center py-6'>
          <p className='lg:text-xl text-[14px] font-semibold'>An Error Occured During Payment!</p>
        </div>
