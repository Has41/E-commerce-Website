         ...
         {/* <div className={`hidden lg:block lg:fixed lg:top-0 lg:right-0 lg:bottom-0 lg:w-96 lg:shadow-xl lg:bg-white lg:transition-transform lg:transform lg:duration-500 ${cartMenuAnimate()} lg:shadow-xl lg:z-50`}>
            ...
            <div className=''>
                {isLoggedIn && cartItems.length !== 0 ? (
                    <div>
                        <div className='fixed top-[750px] right-0 left-2 flex items-center justify-center border-t border-b border-slate-400 py-3 gap-52'>
                        ...
                        <div className='fixed top-[830px] right-0 left-2 flex items-center justify-center'>
                            <Link to={`/myCart`}><button className='px-14 py-2 border-2 border-amber-500 text-amber-500 hover:bg-amber-500 hover:text-white font-poppins text-lg transition-all duration-500 rounded-sm'>View Cart</button></Link>
                        </div>
                    </div>
                ) : (
                    <div className='fixed top-[830px] right-0 left-2 flex items-center justify-center'>
